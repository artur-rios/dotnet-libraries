...
Every package in the set depends on [`ArturRios.Output`](../output/), directly or through
`Relational.Core` / `Export`:

{{< family-deps "ArturRios.Data.Relational.Core" >}}

Current package versions: {{< package-versions "data" >}}.
